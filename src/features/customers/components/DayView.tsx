      ...
      <div className="flex border-b border-border flex-shrink-0">
        ...
        <div className="flex-1 text-center py-2 border-l border-border">
          <p className="text-xs text-muted-foreground uppercase">
            {format(currentDate, "EEEE, dd 'de' MMMM", {
              locale: ptBR,
            })}
          </p>
                ...
                {hourEvents.map((event) => {
                  ...
                  return (
                    <div
                      ...
                      className={`absolute left-1 right-1 top-0 rounded px-2 py-1 text-xs text-foreground z-10 cursor-pointer hover:opacity-90 transition-opacity ${eventColorClasses[event.color]}`}
